...
# Name of job
#SBATCH --job-name=DiTOnlyGaussian
...
# xh_hidden_size used for h_hidden_size
python main_qm9.py --exp_name DiTOnlyGaussian --model dit_only_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
