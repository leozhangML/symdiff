...
# Name of job
#SBATCH --job-name=qm9_best_dg_lr_1e_4_augment_backbone_seed_0
...
python /data/localhost/not-backed-up/$USER/symdiff/eval_analyze.py --model_path outputs/qm9_best_dg_lr_1e_4_augment_backbone_seed_0 --n_samples 10000 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi
