...
# Name of job
#SBATCH --job-name=qm9_dg_augmented_no_symm_9_layers
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_dg_augmented_no_symm_9_layers --model dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --hidden_size 276 --depth 9 --num_heads 6 --mlp_ratio 4 --mlp_dropout 0 --data_augmentation True
