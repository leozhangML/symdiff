...
# Name of job
#SBATCH --job-name=qm9_ddg_9_layers_gam_drop_03
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_ddg_9_layers_gam_drop_03 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --noise_dims 3 --noise_std 1.0 --use_separate_dropout --dropout_gamma_enc 0.3 --dropout_gamma_dec 0.3 --dropout_k 0.0
