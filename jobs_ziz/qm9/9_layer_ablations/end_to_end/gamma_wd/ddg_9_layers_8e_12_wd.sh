...
# Name of job
#SBATCH --job-name=qm9_ddg_9_layers_gam_wd_8e_12
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_ddg_9_layers_gam_wd_8e_12 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --noise_dims 3 --noise_std 1.0 --use_separate_optimisers --lr_K 1e-4 --use_amsgrad_K --weight_decay_K 1e-12  --lr_gamma 1e-4 --use_amsgrad_gamma --weight_decay_gamma 8e-12
