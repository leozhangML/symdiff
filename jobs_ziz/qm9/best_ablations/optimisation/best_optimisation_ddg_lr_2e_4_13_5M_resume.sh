...
# Name of job
#SBATCH --job-name=qm9_best_ddg_lr_2e_4_13_5M_res
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_best_ddg_lr_2e_4_13_5M_new --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --hidden_size 294 --depth 8 --num_heads 6 --mlp_ratio 4.0 --mlp_dropout 0.0 \
                   --noise_dims 3 --noise_std 1.0 \
                   --print_parameter_count --resume /data/localhost/not-backed-up/$USER/symdiff/outputs/qm9_best_ddg_lr_2e_4_13_5M_new \
                   --start_epoch 3913
