...
# Name of job
#SBATCH --job-name=qm9_best_ddg_lr_2e_4_wd_1e_10
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_best_ddg_lr_2e_4_wd_1e_10 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --weight_decay 1e-10 --use_amsgrad --normalize_factors [1,4,10] \
