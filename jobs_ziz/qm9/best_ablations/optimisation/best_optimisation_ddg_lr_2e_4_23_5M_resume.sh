...
# Name of job
#SBATCH --job-name=qm9_best_ddg_lr_2e_4_23_5M_res
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_best_ddg_lr_2e_4_23_5M_new --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --diffusion_noise_schedule polynomial_2 \
                   --n_epochs 4350 --batch_size 256 --lr 2e-4 --com_free --clipping_type norm --max_grad_norm 2.0 --ema_decay 0.9999 \
                   ...
                   --hidden_size 360 --depth 10 --num_heads 6 --mlp_ratio 4.0 --mlp_dropout 0.0 \
                   --noise_dims 3 --noise_std 1.0 \
                   --print_parameter_count --resume /data/localhost/not-backed-up/$USER/symdiff/outputs/qm9_best_ddg_lr_2e_4_23_5M_new \
                   --start_epoch 3387
