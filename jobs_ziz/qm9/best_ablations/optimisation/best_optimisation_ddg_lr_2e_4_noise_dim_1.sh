...
# Name of job
#SBATCH --job-name=qm9_best_optimisation_ddg_lr_2e_4_noise_dim_1
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_best_optimisation_ddg_lr_2e_4_noise_dim_1 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
