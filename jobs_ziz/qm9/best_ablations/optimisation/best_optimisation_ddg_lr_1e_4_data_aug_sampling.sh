...
# Name of job
#SBATCH --job-name=qm9_best_ddg_lr_1e_4_data_aug_sampling
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_best_ddg_lr_1e_4_data_aug_sampling --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --print_parameter_count --data_aug_at_sampling
