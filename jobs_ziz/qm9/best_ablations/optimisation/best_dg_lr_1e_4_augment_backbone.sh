...
# Name of job
#SBATCH --job-name=qm9_best_dg_lr_1e_4_augment_backbone
...
python /data/localhost/not-backed-up/$USER/symdiff/main_qm9.py --exp_name qm9_best_dg_lr_1e_4_augment_backbone --model dit_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/nvme00/ashouritaklimi \
                   ...
                   --hidden_size 384 --depth 12 --num_heads 6 --mlp_ratio 4 --mlp_dropout 0  --data_augmentation True
