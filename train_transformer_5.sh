...
python main_qm9.py --n_epochs 2000 --exp_name transformer_test_big_x_0 --model transformer_dynamics --n_stability_samples 500 --diffusion_noise_schedule polynomial_2 \
       --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --batch_size 512 --lr 1e-4 --normalize_factors [1,4,10] \
        ...
        --save_model True --trans_num_layers 8 --trans_d_model 256 --trans_nhead 4 --trans_dim_feedforward 256 --trans_dropout 0.1 \
