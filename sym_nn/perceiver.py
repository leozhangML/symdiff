...
class PerceiverMultimodalDecoder(PerceiverAbstractDecoder):  # NOTE: look at this later for multi-modal processing in MiDi
    """
    ...
    def __init__(
        ...
        **decoder_kwargs,
        ...
        self.decoder = EDMPerceiverDecoder(
            config,
    ...
    def decoder_query(self, inputs, modality_sizes, inputs_without_pos=None, subsampled_points=None):
        # Partition the flat inputs among the different modalities: dict
