...
# Name of job
#SBATCH --job-name=DiTGaussian_aug_layer_9
...
python main_qm9.py --exp_name DiTGaussian_aug_layer_9 --model dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
