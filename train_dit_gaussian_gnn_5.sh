...
# Name of job
#SBATCH --job-name=DiTGaussian_GNN
...
python main_qm9.py --exp_name DiTGaussian_GNN --model dit_gaussian_gnn_dynamics --dataset qm9  --datadir /data/zizgpu05/not-backed-up/nvme00/lezhang \
                   --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --diffusion_noise_schedule polynomial_2 \
                   --n_epochs 1200 --batch_size 128 --lr 1e-4 --com_free --clipping_type queue --ema_decay 0.9999 \
                   ...
                   --pos_size 64 --K 128 \
                   --enc_hidden_size 64 --enc_depth 4 --enc_num_heads 4 --enc_mlp_ratio 4.0 \
