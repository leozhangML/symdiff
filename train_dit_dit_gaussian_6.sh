...
# Name of job
#SBATCH --job-name=DiT_DiTGaussian_tune
...
python main_qm9.py --exp_name DiT_DiTGaussian_tune --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
                   ...
                   --weight_decay 1e-2 --use_amsgrad --normalize_factors [1,4,10] \
