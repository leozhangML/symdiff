...
# Name of job
#SBATCH --job-name=DiT_DiTGaussian_ema_base
...
python main_qm9.py --exp_name DiT_DiTGaussian_ema_base --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
                   --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --diffusion_noise_schedule polynomial_2 \
                   --n_epochs 3000 --batch_size 256 --lr 5e-4 --com_free --clipping_type queue --ema_decay 0.9999 \
                   ...
                   --enc_hidden_size 256 --enc_depth 6 --enc_num_heads 8 --enc_mlp_ratio 1.0 --dec_hidden_features 128 \
                   --hidden_size 384 --depth 12 --num_heads 16 --mlp_ratio 1.5 --mlp_dropout 0.1 \
