...
# Name of job
#SBATCH --job-name=DiT_DiTGaussian_test_noise_1
...
python main_qm9.py --exp_name DiT_DiTGaussian_test_noise_1 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
