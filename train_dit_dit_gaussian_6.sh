...
# Name of job
#SBATCH --job-name=DiT_DiTGaussian_random_init
...
python main_qm9.py --exp_name DiT_DiTGaussian_random_init_fix_qr --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
                   ...
                   --n_stability_samples 500 --test_epochs 2 --wandb_usr zhangleo1209 --save_model True \
                   --xh_hidden_size 184 --K 184 --pos_embedder_test 184 \
                   --mlp_type swiglu \
