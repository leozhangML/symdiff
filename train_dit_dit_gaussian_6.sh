...
# Name of job
#SBATCH --job-name=DiT_DiTGaussian_tune_dropout
...
python main_qm9.py --exp_name DiT_DiTGaussian_tune_dropout --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
                   --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --diffusion_noise_schedule polynomial_2 \
                   --n_epochs 4350 --batch_size 256 --lr 3e-4 --com_free --clipping_type norm --max_grad_norm 2.0 --ema_decay 0.9999 \
                   ...
                   --mlp_type swiglu \
                   --enc_hidden_size 128 --enc_depth 4 --enc_num_heads 4 --enc_mlp_ratio 4.0 --dec_hidden_features 64 --gamma_mlp_dropout 0.1 \
