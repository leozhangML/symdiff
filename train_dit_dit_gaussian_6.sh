...
# Name of job
#SBATCH --job-name=DiT_DiTGaussian_noise_dims_2
...
python main_qm9.py --exp_name DiT_DiTGaussian_noise_dims_2 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
                   ...
                   --xh_hidden_size 184 --K 184 --pos_embedder_test 200 \
                   --mlp_type swiglu \
                   --enc_hidden_size 128 --enc_depth 4 --enc_num_heads 4 --enc_mlp_ratio 4.0 --dec_hidden_features 64 --gamma_mlp_dropout 0.0 \
                   --hidden_size 384 --depth 12 --num_heads 6 --mlp_ratio 4.0 --mlp_dropout 0.0 \
                   --noise_dims 2 --noise_std 1.0 \
