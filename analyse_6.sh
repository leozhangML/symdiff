...
# Name of job
#SBATCH --job-name=analyse_DiT_DiTGaussian_SwiGLU
...
python eval_analyze.py --model_path outputs/DiT_DiTGaussian_SwiGLU --n_samples 10000 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang
#python t.py
