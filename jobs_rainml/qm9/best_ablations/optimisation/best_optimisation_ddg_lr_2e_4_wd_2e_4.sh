...
# Name of job
#SBATCH --job-name=test_qm9_best_ddg_lr_2e_4_wd_2e4
...
python /vols/bitbucket/$USER/symdiff/main_qm9.py --exp_name test_qm9_best_ddg_lr_2e_4_wd_2e4 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/users/$USER/data/
