...
# Name of job
#SBATCH --job-name=qm9_best_ddg_lr_2e_4_wd_2e4
...
python /data/localhost/not-backed-up/users/$USER/symdiff/main_qm9.py --exp_name qm9_best_ddg_lr_2e_4_wd_2e4 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/users/$USER/data/
                   ...
                   --weight_decay 2e-4 --use_amsgrad --normalize_factors [1,4,10] \
