...
# Name of job
#SBATCH --job-name=qm9_best_ddg_lr_0_01
...
python /data/localhost/not-backed-up/users/$USER/symdiff/main_qm9.py --exp_name qm9_best_ddg_lr_0_01 --model dit_dit_gaussian_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/users/$USER/data/
                   --diffusion_noise_precision 1e-5 --diffusion_steps 1000 --diffusion_loss_type l2 --diffusion_noise_schedule polynomial_2 \
                   --n_epochs 5000 --batch_size 256 --lr 0.01 --com_free --clipping_type norm --max_grad_norm 2.0 --ema_decay 0.9999 \
