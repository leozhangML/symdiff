...
# Name of job
#SBATCH --job-name=qm9_best_dg_lr_2e_4_aug_no_symm
...
python /data/localhost/not-backed-up/users/$USER/symdiff/main_qm9.py --exp_name qm9_best_dg_lr_2e_4_aug_no_symm --model dit_dynamics --dataset qm9 --datadir /data/localhost/not-backed-up/users/$USER/data/ \
