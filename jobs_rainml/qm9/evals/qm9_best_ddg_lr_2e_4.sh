...
# Name of job
#SBATCH --job-name=eval_qm9_best_ddg_lr_2e_4
...
python /data/localhost/not-backed-up/users/$USER/symdiff/eval_analyze.py --model_path outputs/qm9_best_ddg_lr_2e_4 --n_samples 10000 --datadir /data/localhost/not-backed-up/users/$USER/data/
