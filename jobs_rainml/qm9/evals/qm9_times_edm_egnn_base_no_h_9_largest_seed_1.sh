...
# Name of job
#SBATCH --job-name=qm9_times_edm_egnn_base_no_h_9_largest_seed_1
...
python /data/localhost/not-backed-up/users/$USER/symdiff/eval_analyze.py --model_path outputs/qm9_times_edm_egnn_base_no_h_9_largest_seed_1 --n_samples 10000 --datadir /data/localhost/not-backed-up/users/$USER/data/
