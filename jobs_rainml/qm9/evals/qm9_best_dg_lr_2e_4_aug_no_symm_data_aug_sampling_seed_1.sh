...
# Name of job
#SBATCH --job-name=eval_qm9_best_dg_lr_2e_4_aug_no_symm_data_aug_sampling_seed_1
...
python /data/localhost/not-backed-up/users/$USER/symdiff/eval_analyze.py --model_path outputs/qm9_best_dg_lr_2e_4_aug_no_symm_data_aug_sampling_seed_1 --n_samples 10000 --datadir /data/localhost/not-backed-up/users/$USER/data/  --data_aug_at_sampling True
