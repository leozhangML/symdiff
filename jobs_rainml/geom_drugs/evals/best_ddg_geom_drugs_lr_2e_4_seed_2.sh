...
# Name of job
#SBATCH --job-name=eval_best_ddg_geom_drugs_lr_2e_4_seed_2
...
python /data/localhost/not-backed-up/users/$USER/symdiff/eval_analyze.py --model_path outputs/best_ddg_geom_drugs_lr_2e_4_seed_2 --n_samples 10000 --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy
