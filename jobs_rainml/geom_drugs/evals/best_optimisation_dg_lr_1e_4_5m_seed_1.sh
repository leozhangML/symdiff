...
# Name of job
#SBATCH --job-name=eval_best_optimisation_dg_lr_1e_4_5m_seed_1
...
python /data/localhost/not-backed-up/users/$USER/symdiff/eval_analyze.py --model_path outputs/best_optimisation_dg_lr_1e_4_5m_seed_1 --n_samples 10000 --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy
