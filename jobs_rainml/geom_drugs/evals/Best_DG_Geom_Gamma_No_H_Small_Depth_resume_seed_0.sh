...
# Name of job
#SBATCH --job-name=eval_Best_DG_Geom_Gamma_No_H_Small_Depth_resume_seed_0
...
python /data/localhost/not-backed-up/users/$USER/symdiff/eval_analyze.py --model_path outputs/Best_DG_Geom_Gamma_No_H_Small_Depth_resume_seed_0 --n_samples 10000 --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy
