...
# Name of job
#SBATCH --job-name=best_optimisation_dg_lr_1e_4_10m_aug
...
# Run main script
python /data/localhost/not-backed-up/users/$USER/symdiff/main_geom_drugs.py --exp_name best_optimisation_dg_lr_1e_4_10m_aug --model dit_gaussian_dynamics --dataset geom --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy \
                   ...
                   --hidden_size 264 --depth 6 --num_heads 6 --mlp_ratio 4 --mlp_dropout 0  --data_augmentation True
