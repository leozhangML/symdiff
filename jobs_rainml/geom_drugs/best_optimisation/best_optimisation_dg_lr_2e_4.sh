...
# Name of job
#SBATCH --job-name=dg_geom_drugs_no_symm_aug_lr_2e_4
...
# Run main script
python /data/localhost/not-backed-up/users/$USER/symdiff/main_geom_drugs.py --exp_name dg_geom_drugs_no_symm_aug_lr_2e_4 --model dit_gaussian_dynamics --dataset geom --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy \
