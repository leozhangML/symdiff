...
# Name of job
#SBATCH --job-name=dt_geom_drugs_no_symm_no_aug
...
# Run main script
python /data/localhost/not-backed-up/users/$USER/symdiff/main_geom_drugs.py --exp_name Best_DIT_No_Symm_Geom_No_H_Small_Depth_No_Aug_No_Symm --model dit_gaussian_dynamics --dataset geom --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy \
                   ...
                   --hidden_size 384 --depth 8 --num_heads 6 --mlp_ratio 4 --mlp_dropout 0 
