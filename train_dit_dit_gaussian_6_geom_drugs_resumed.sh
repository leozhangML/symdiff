...
# Name of job
#SBATCH --job-name=dt_geom_drugs_resumed
...
python /data/localhost/not-backed-up/users/$USER/symdiff/main_geom_drugs.py --exp_name Best_DG_Geom_Gamma_No_H_Small_Depth --model dit_dit_gaussian_dynamics --dataset geom --datadir /data/localhost/not-backed-up/users/$USER/data/geom/geom_drugs_30.npy \
                   ...
                   --print_parameter_count --start_epoch 20 --resume /data/localhost/not-backed-up/users/$USER/symdiff/outputs/Best_DG_Geom_Gamma_No_H_Small_Depth
