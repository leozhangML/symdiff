...
python main_qm9.py --exp_name DiTEmb_mask --model dit_emb_dynamics --dataset qm9 --datadir /data/zizgpu06/not-backed-up/nvme00/lezhang \
                   ...
                   --xh_hidden_size 182 --sigma 0.5 --m 64 \
                   --hidden_size 384 --depth 12 --num_heads 8 --mlp_ratio 1.5 --x_emb linear --mlp_dropout 0.1
