...
def get_model(args, device, dataset_info, dataloader_train):
    ...
    if args.model == "egnn_dynamics" or args.model == "gnn_dynamics":
        ...
        net_dynamics = DiT_DitGaussian_dynamics(
            ...
            #gamma_mlp_dropout=args.gamma_mlp_dropout,
            gamma_mlp_dropout=args.gamma_dropout,
        ...
        net_dynamics = DiTModPE_DitGaussian_dynamics(
            args,
            in_node_nf=in_node_nf,
            context_node_nf=args.context_node_nf,
    ...
    elif args.model == "ditfinal_dit_gaussian_dynamics":

        net_dynamics = DiTFinal_DitGaussian_dynamics(
            args,
            in_node_nf=in_node_nf,
            context_node_nf=args.context_node_nf,
    ...
    elif args.model == "scalarsdit_dit_gaussian_dynamics":

        net_dynamics = ScalarsDiT_DitGaussian_dynamics(
            args,
            in_node_nf=in_node_nf,
            context_node_nf=args.context_node_nf,
    ...
    elif args.model == "scalarsdit_pe_ditgaussian_dynamics":
        net_dynamics = ScalarsDiT_PE_DitGaussian_dynamics(args,
            in_node_nf=in_node_nf,
            context_node_nf=args.context_node_nf,
            xh_hidden_size=args.xh_hidden_size,
            K=args.K,
            xh_gamma_hidden_size=args.xh_gamma_hidden_size,
