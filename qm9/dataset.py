...
def retrieve_dataloaders(cfg):
    if 'qm9' in cfg.dataset:
        ...
        # data_dir = cfg.data_root_dir - not used
        # charge scale is max_charge, num_species is len(included_species), datasets is a dict of ProcessedDataset
        ...
        preprocess = PreprocessQM9(load_charges=cfg.include_charges)  # creates charges, atom mask, edge mask, padding etc.
